...
const ApplicationJob = () => {
  ...
  <div className="max-w-[1000px] mx-auto">
    ...
    <div className="mb-lg text-center">
      ...
      <h1 className="font-h1 text-primary mb-xs">Senior UI/UX Designer</h1>
    ...
    <div className="bg-white rounded-xl shadow-[0_4px_20px_rgba(15,23,42,0.05)] overflow-hidden w-full">
      ...
      <div className="p-lg border-b border-surface-container">
        <h3 className="font-h3 text-primary mb-md">Personal Information</h3>
      ...
      <div className="p-lg border-b border-surface-container bg-surface-container-low">
        <h3 className="font-h3 text-primary mb-md">Application Documents</h3>
        <div className="mb-md">
          ...
          <div className="border-2 border-dashed border-outline-variant rounded-xl p-xl flex flex-col items-center justify-center bg-white hover:border-secondary transition-colors cursor-pointer group">
            ...
            <p className="font-body-sm text-outline">PDF, DOCX up to 10MB</p>
      ...
      <div className="p-lg">
        <h3 className="font-h3 text-primary mb-md">Portfolio &amp; Links</h3>
          ...
          <div className="flex flex-col gap-xs">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full border border-outline-variant rounded-lg p-3 pl-10 focus:ring-2 focus:ring-secondary focus:border-secondary outline-none transition-all"
              />
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-md">
      ...
      <div className="p-lg bg-surface-container flex flex-col md:flex-row justify-between items-center gap-md">
        ...
        <div className="flex gap-md w-full md:w-auto">
          ...
          <button className="flex-1 md:flex-none px-xl py-4 bg-primary text-on-primary font-bold rounded-lg hover:opacity-90 active:scale-95 transition-all cursor-pointer" onClick={() => navigate(`/jobs/application/experience/5`)}>
    ...
    <div className="mt-lg flex items-center justify-center gap-sm text-outline-variant">
      ...
      <span className="font-body-sm">
        Your data is securely processed and shared only with the hiring team.
      </span>
    </div>
  </div>
</main>
