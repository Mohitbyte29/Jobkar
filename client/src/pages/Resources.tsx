...
export default function Resources(){
  ...
  <section className="mb-lg">
    <div className="relative overflow-hidden rounded-xl bg-[#22C55E]/10 p-12 flex flex-col md:flex-row items-center gap-md">
      <div className="z-10 flex-1">
        <span className="inline-block px-3 py-1 bg-[#22C55E]/15 text-[#34D399] rounded-full text-label-caps mb-sm uppercase">
          Expert Career Advice
        </span>
        <h1 className="font-display text-display text-[#F1F5F2] mb-sm">
          Elevate Your Career Path
        </h1>
        <p className="font-body-lg text-body-lg text-[#22C55E] max-w-xl mb-md">
        ...
        <div className="flex gap-sm">
          <div className="relative flex-grow max-w-md">
            <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-[#9AAEA3]/70">
              search
            </span>
            <input
  ...
  <section className="mb-lg">
    <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
      ...
      <div className="md:col-span-2 group relative overflow-hidden rounded-xl bg-[#111F19] shadow-[0px_4px_20px_rgba(15,23,42,0.05)] p-md border border-[#20352B] transition-all hover:border-[#22C55E] hover:shadow-lg">
        <div className="flex flex-col h-full">
          <div className="flex justify-between items-start mb-md">
            ...
            <span className="text-label-caps text-[#22C55E] font-bold">
              128 ARTICLES
            </span>
          </div>
          <h2 className="font-h2 text-h2 mb-sm">Career Growth</h2>
          <p className="text-[#9AAEA3] text-body-md mb-md flex-grow">
            Strategic advice on navigating promotions, switching industries, and
            building long-term career resilience.
          </p>
          <div className="grid grid-cols-2 gap-sm">
            <div className="bg-[#0D1814] p-sm rounded-lg hover:bg-[#111F19] transition-colors cursor-pointer">
              <p className="font-label-strong text-[#F1F5F2]">
                Negotiating Salaries
              </p>
              <span className="text-body-sm text-[#9AAEA3]/70">
      ...
      <div className="group relative overflow-hidden rounded-xl bg-[#22C55E] text-[#F1F5F2] p-md transition-all hover:shadow-xl">
        <div className="flex flex-col h-full relative z-10">
          <div className="p-3 bg-[#111F19]/10 rounded-xl text-[#F1F5F2] mb-md w-fit">
            <span
              className="material-symbols-outlined"
              style={{ fontVariationSettings: '"FILL" 1' }}
            >
          ...
          <p className="text-[#07110D]-fixed-variant text-body-md mb-md">
            Craft a resume that passes ATS and catches the recruiter's eye every
            single time.
          </p>
          <a
            className="mt-auto flex items-center text-[#22C55E]-fixed font-label-strong gap-xs"
            href="#"
          >
            Explore Templates
  ...
  <div className="grid grid-cols-1 lg:grid-cols-12 gap-gutter">
    ...
    <aside className="lg:col-span-3">
      <div className="sticky top-24 space-y-md">
        <div>
          <h3 className="font-label-strong text-label-caps text-[#9AAEA3]/70 mb-sm uppercase tracking-widest">
            Resources by Category
          </h3>
          <div className="space-y-1">
            <button className="w-full flex justify-between items-center px-4 py-2 bg-[#22C55E]/15 text-[#34D399] rounded-lg font-label-strong">
              All Resources <span className="text-xs">42</span>
            </button>
            <button className="w-full flex justify-between items-center px-4 py-2 hover:bg-[#0D1814] text-[#9AAEA3] rounded-lg font-label-strong transition-colors">
              Interview Prep <span className="text-xs text-[#9AAEA3]/70">12</span>
            </button>
            <button className="w-full flex justify-between items-center px-4 py-2 hover:bg-[#0D1814] text-[#9AAEA3] rounded-lg font-label-strong transition-colors">
              Resume Tips <span className="text-xs text-[#9AAEA3]/70">15</span>
            </button>
            <button className="w-full flex justify-between items-center px-4 py-2 hover:bg-[#0D1814] text-[#9AAEA3] rounded-lg font-label-strong transition-colors">
              Career Advice <span className="text-xs text-[#9AAEA3]/70">8</span>
            </button>
            <button className="w-full flex justify-between items-center px-4 py-2 hover:bg-[#0D1814] text-[#9AAEA3] rounded-lg font-label-strong transition-colors">
              Workplace Culture <span className="text-xs text-[#9AAEA3]/70">7</span>
            </button>
          </div>
        </div>
        <div className="p-6 rounded-xl bg-[#111F19] border border-[#20352B] shadow-sm">
          <h4 className="font-h3 text-h3 mb-xs text-[#F1F5F2]">
            Need a Resume Review?
          </h4>
          <p className="text-body-sm text-[#9AAEA3] mb-md">
            Our experts can provide feedback in 48 hours.
          </p>
          <button className="w-full py-3 border-2 border-[#22C55E] text-[#22C55E] rounded-lg font-label-strong hover:bg-[#22C55E]/15 transition-colors">
            Get Expert Review
          </button>
        </div>
      </div>
    ...
    <div className="lg:col-span-9">
      <div className="flex justify-between items-center mb-md">
        <h3 className="font-h2 text-h2 text-[#F1F5F2]">Latest Guides</h3>
        <div className="flex items-center gap-xs">
          <span className="text-label-caps text-[#9AAEA3]/70">SORT BY</span>
          <select className="bg-transparent border-none text-label-strong text-[#F1F5F2] focus:ring-0 cursor-pointer">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-gutter">
        {/* Article Card 1 */}
        <article className="bg-[#111F19] rounded-xl overflow-hidden shadow-[0px_4px_20px_rgba(15,23,42,0.05)] border border-[#20352B] group">
          <div className="aspect-video relative overflow-hidden">
            ...
            <div className="absolute top-4 left-4">
              <span className="bg-[#111F19]/90 backdrop-blur px-3 py-1 rounded-full text-label-caps text-[#F1F5F2] shadow-sm">
                INTERVIEW PREP
              </span>
            </div>
          </div>
          <div className="p-6">
            <h3 className="font-h3 text-h3 mb-xs group-hover:text-[#22C55E] transition-colors cursor-pointer">
              10 Behavioral Questions and How to Answer Them
            </h3>
            <p className="text-[#9AAEA3] text-body-md mb-md line-clamp-2">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-xs">
                <img
                  className="w-8 h-8 rounded-full border border-[#20352B]"
                ...
                />
                <span className="text-label-strong text-[#F1F5F2]">
                  Sarah Chen
                </span>
              </div>
              <span className="text-label-caps text-[#9AAEA3]/70">8 MIN READ</span>
            </div>
          </div>
        </article>
        {/* Article Card 2 */}
        <article className="bg-[#111F19] rounded-xl overflow-hidden shadow-[0px_4px_20px_rgba(15,23,42,0.05)] border border-[#20352B] group">
          ...
          <div className="p-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-label-caps text-[#9AAEA3]/70">5 MIN READ</span>
            </div>
          </div>
        </article>
        {/* Article Card 3 */}
        <article className="bg-[#111F19] rounded-xl overflow-hidden shadow-[0px_4px_20px_rgba(15,23,42,0.05)] border border-[#20352B] group">
          ...
          <div className="p-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-label-caps text-[#9AAEA3]/70">12 MIN READ</span>
            </div>
          </div>
        </article>
        {/* Article Card 4 */}
        <article className="bg-[#111F19] rounded-xl overflow-hidden shadow-[0px_4px_20px_rgba(15,23,42,0.05)] border border-[#20352B] group">
          ...
          <div className="p-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-label-caps text-[#9AAEA3]/70">6 MIN READ</span>
            </div>
          </div>
        </article>
      </div>
      ...
      <div className="mt-lg flex justify-center items-center gap-sm">
        <button className="w-10 h-10 flex items-center justify-center rounded-lg border border-[#20352B] text-[#9AAEA3]/70 hover:border-[#22C55E] hover:text-[#22C55E] transition-colors">
          <span className="material-symbols-outlined">chevron_left</span>
        </button>
        <button className="w-10 h-10 flex items-center justify-center rounded-lg bg-[#22C55E] text-[#07110D] font-label-strong">
          1
        </button>
        <button className="w-10 h-10 flex items-center justify-center rounded-lg border border-[#20352B] text-[#F1F5F2] hover:border-[#22C55E] transition-colors">
          2
        </button>
        <button className="w-10 h-10 flex items-center justify-center rounded-lg border border-[#20352B] text-[#F1F5F2] hover:border-[#22C55E] transition-colors">
          3
