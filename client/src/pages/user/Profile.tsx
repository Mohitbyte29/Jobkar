...
const Profile = () => {
  ...
  <main className="flex-1 ml-64 p-8">
    ...
    >
      <button className="text-[#9AAEA3] hover:text-[#9AAEA3]">
        <i className="fas fa-search text-lg" />
      </button>
      <button className="relative text-[#9AAEA3] hover:text-[#9AAEA3]">
        <i className="fas fa-bell text-lg" />
        <span className="absolute -top-1 -right-1 w-4 h-4 bg-job-blue border-2 border-job-bg rounded-full text-[10px] text-[#F1F5F2] flex items-center justify-center">
          1
        </span>
      </button>
      <div className="flex items-center space-x-2 border-l border-job-border pl-6">
        ...
        />
        <i className="fas fa-chevron-down text-xs text-[#9AAEA3]" />
      </div>
    </header>
    {/* END: Top Header Bar */}
    {/* BEGIN: Profile Header Section */}
    <section
      className="bg-[#111F19] rounded-3xl border border-job-border overflow-hidden mb-8"
      ...
      <div className="px-8 pb-8 relative">
        <div className="flex flex-col md:flex-row md:items-end -mt-16 mb-6">
          ...
          <div className="md:ml-6 mb-2 mt-4">
            ...
            <div className="flex items-center mt-1 text-[#9AAEA3]/70 text-sm">
              <i className="fas fa-map-marker-alt mr-2" />
              <span>{profile.user.city}, {profile.user.country}</span>
              <span className="mx-3 text-[#9AAEA3]">|</span>
          ...
          <div className="md:ml-auto mb-2">
            <button className="bg-[#22C55E] text-[#07110D] px-6 py-2 rounded-xl font-semibold text-sm hover:opacity-90 flex items-center transition-all shadow-sm active:scale-95 cursor-pointer" onClick={() => {navigate('/edit-profile')}}><span className="material-symbols-outlined mr-2">edit</span> Edit Profile</button>
          </div>  
        </div>
        {/* Contact Links */}
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 pt-6 border-t border-job-border">
          <button className="flex items-center space-x-2 text-[#F1F5F2] bg-black p-2 rounded-xl  hover:text-job-blue cursor-pointer">
            <i className="fas fa-envelope text-[#9AAEA3]" />
            <span className="text-xs truncate">{user?.email}</span>
          </button>
          <button className="flex items-center space-x-2 text-[#F1F5F2] bg-black p-2 rounded-xl  hover:text-job-blue cursor-pointer">
            <i className="fas fa-phone text-[#9AAEA3]" />
            <span className="text-xs">{profile.user.phoneNumber}</span>
          </button>
          <button onClick={() => window.open(profile.user.portfolio, '_blank')} className="flex items-center space-x-2 text-[#F1F5F2] bg-black  p-2 rounded-xl hover:text-job-blue cursor-pointer">
            <i className="fas fa-link text-[#9AAEA3]" />
            <span className="text-xs">{profile.user.portfolio}</span>
          </button>
          <button onClick={() => window.open(profile.user.github, '_blank')} className="flex items-center space-x-2 text-[#F1F5F2] bg-black p-2 rounded-xl  hover:text-job-blue cursor-pointer">
            <i className="fab fa-github text-[#9AAEA3]" />
            <span className="text-xs">{profile.user.github}</span>
          </button>
          <button onClick={() => window.open(profile.user.linkedIn, '_blank')} className="flex items-center space-x-2 text-[#F1F5F2] bg-black p-2 rounded-xl  hover:text-job-blue cursor-pointer">
            <i className="fab fa-linkedin text-[#9AAEA3]" />
    ...
    <div className="grid grid-cols-12 gap-8">
      ...
      <div className="col-span-8 space-y-8">
        <div className="grid grid-cols-2 gap-8">
          {/* BEGIN: About Me */}
          <section
            className="bg-[#111F19] p-6 rounded-3xl border border-job-border h-full"
            data-purpose="about-me"
          >
            <div className="flex items-center space-x-2 mb-4">
              <i className="far fa-user text-job-blue text-lg" />
              <h3 className="font-bold text-[#F1F5F2]">About Me</h3>
            </div>
            <p className="text-sm text-[#9AAEA3]/70 leading-relaxed">
          ...
          <section className="grid grid-cols-3 gap-3" data-purpose="stats-grid">
            {/* Stat Card 1 */}
            <div className="bg-[#111F19] p-4 rounded-2xl border border-job-border flex flex-col items-center justify-center text-center">
              ...
              <div className="text-[10px] text-[#9AAEA3] font-medium uppercase tracking-tight">
                Jobs Applied
              </div>
            </div>
            {/* Stat Card 2 */}
        ...
        <section
          className="bg-[#111F19] p-6 rounded-3xl border border-job-border"
          data-purpose="skills"
        >
          <div className="flex items-center space-x-2 mb-6">
            <i className="fas fa-code text-job-blue text-lg" />
            <h3 className="font-bold text-[#F1F5F2]">Skills</h3>
          </div>
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="font-bold text-[#F1F5F2]">Experience</h3>
            </div>
          </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  <h4 className="font-bold text-[#F1F5F2]">
                ...
                <p className="text-[#9AAEA3] text-[10px] mt-1 uppercase tracking-wide">
                  Jan 2024 - Present • 1 yr 3 mos
                </p>
                <p className="text-sm text-[#9AAEA3]/70 mt-2 leading-relaxed">
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="font-bold text-[#F1F5F2]">Projects</h3>
            </div>
          ...
          <div className="grid grid-cols-3 gap-6">
            ...
            <div className="group border border-job-border rounded-2xl overflow-hidden hover:shadow-md transition-shadow">
              <div className="h-28 bg-[#0D1814] overflow-hidden relative">
                <img
                  alt="Project 1"
              ...
              <div className="p-3">
                <h5 className="text-xs font-bold text-[#F1F5F2]">
                  AI Job Portal
                </h5>
                <p className="text-[10px] text-[#9AAEA3] mt-1 line-clamp-2">
                  AI-powered job portal that matches candidates with relevant
                  opportunities.
                </p>
                <div className="flex flex-wrap gap-1 mt-3 mb-3">
                  <span className="text-[8px] bg-slate-50 px-1.5 py-0.5 rounded text-[#9AAEA3]/70">
                    MERN
                  </span>
                  <span className="text-[8px] bg-slate-50 px-1.5 py-0.5 rounded text-[#9AAEA3]/70">
                    Tailwind
                ...
                <div className="flex items-center space-x-3 text-[#9AAEA3]">
                  <i className="fab fa-github text-sm hover:text-[#9AAEA3] cursor-pointer" />
                  <i className="fas fa-link text-sm hover:text-[#9AAEA3] cursor-pointer" />
                </div>
              </div>
            </div>
            {/* Project 2 */}
          ...
          <div className="flex justify-center mt-6 space-x-1.5">
            ...
            <span className="w-1.5 h-1.5 bg-[#162820] rounded-full" />
            <span className="w-1.5 h-1.5 bg-[#162820] rounded-full" />
            <span className="w-1.5 h-1.5 bg-[#162820] rounded-full" />
          </div>
        </section>
        ...
        >
          <div className="flex items-center space-x-2 mb-6">
            ...
            <h3 className="font-bold text-[#F1F5F2]">Achievements</h3>
          </div>
          <div className="grid grid-cols-4 gap-4">
            <div className="p-4 border border-job-border rounded-2xl flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-[9px] text-[#9AAEA3] font-medium">
                  LeetCode Problems
                </div>
              </div>
            </div>
      ...
      <aside className="col-span-4 space-y-8">
        ...
        >
          <div className="flex items-center space-x-2 mb-6">
            ...
            <h3 className="font-bold text-[#F1F5F2]">Recent Activity</h3>
          </div>
          <div className="space-y-6 relative before:content-[''] before:absolute before:left-[11px] before:top-2 before:bottom-0 before:w-[1px] before:bg-[#0D1814]">
            {/* Activity Item 1 */}
            <div className="relative pl-8">
              <div className="absolute left-0 top-1 w-[22px] h-[22px] bg-[#111F19] border border-job-border rounded-full flex items-center justify-center z-10">
              ...
              <div>
                ...
                <p className="text-[10px] text-[#9AAEA3] mt-1">2 hours ago</p>
              </div>
            </div>
            {/* Activity Item 2 */}
            <div className="relative pl-8">
              ...
              <div>
                ...
                <p className="text-[10px] text-[#9AAEA3] mt-1">1 day ago</p>
              </div>
            </div>
            {/* Activity Item 3 */}
            <div className="relative pl-8">
              ...
              <div>
                ...
                <p className="text-[10px] text-[#9AAEA3] mt-1">3 days ago</p>
              </div>
            </div>
            {/* Activity Item 4 */}
            <div className="relative pl-8">
              ...
              <div>
                ...
                <p className="text-[10px] text-[#9AAEA3] mt-1">5 days ago</p>
              </div>
            </div>
          </div>
          <button className="w-full mt-8 py-2 border border-[#20352B] rounded-xl text-xs font-bold text-job-blue hover:bg-[#0D1814] transition-colors uppercase tracking-wide">
            View All Activity
          </button>
        </section>
        {/* END: Recent Activity */}
        ...
        >
          <div className="flex items-center space-x-2 mb-6">
            ...
            <h3 className="font-bold text-[#F1F5F2]">Education</h3>
          </div>
          <div className="space-y-4">
            <div>
              ...
              <p className="text-xs text-[#9AAEA3]/70 mt-1 leading-relaxed">
                {profile.user.university}
              </p>
              <p className="text-[10px] text-[#9AAEA3] mt-1 uppercase tracking-wide">
        ...
        >
          <div className="flex items-center space-x-2 mb-6">
            ...
            <h3 className="font-bold text-[#F1F5F2]">Resume</h3>
          </div>
          <div className="flex items-center space-x-4 p-4 border border-job-border rounded-2xl bg-slate-50">
            <div className="w-12 h-12 bg-[#111F19] border border-job-border rounded-xl flex items-center justify-center shrink-0">
              <i className="fas fa-file-pdf text-red-500 text-xl" />
            </div>
            <div className="flex-1 overflow-hidden">
              <h5 className="text-xs font-bold text-[#F1F5F2] truncate">
                Resume.pdf
              </h5>
              <p className="text-[10px] text-[#9AAEA3] mt-0.5">
